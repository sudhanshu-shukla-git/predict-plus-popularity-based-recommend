...
class mf_popularity():
    ...
    def performance_based_recommendation(self,mf_category=None,mf_sub_category=None,risk=None,top_n=5,load_cache=True,user_mf_json=None):
        try:
    ...
    def get_popularity_based_funds(self,mf_category=None,mf_sub_category=None,risk=None,top_n=5,load_cache=True,user_mf_json=None):
        ...
        suggested_mf=list(set(filter_df["fund_name"]))[:5]
    #     if risk is not None:        
